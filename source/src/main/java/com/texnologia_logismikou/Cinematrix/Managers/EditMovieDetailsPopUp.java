...
import com.texnologia_logismikou.Cinematrix.Controllers.EditMovieDetailsPopUpContoller;
...
public class EditMovieDetailsPopUp
extends Manager<EditMovieDetailsPopUpContoller>
{
	private Dialog<ButtonType> dialog = null;
	private Movie movie = null;
	
	public EditMovieDetailsPopUp(Movie movie)
	{	
		super.loadFXML("EditMovieDetailsPopUp");
		this.movie = movie;
		getController().setData(movie);
